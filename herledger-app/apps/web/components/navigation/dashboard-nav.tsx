    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", position: "relative" }}>
        ...
        <button 
          ...
          style={{ 
            background: "none", border: "none", cursor: "pointer", position: "relative", padding: "0.25rem" 
          }}
        ...
        {showDropdown && (
          <div style={{
            position: "absolute", top: "100%", right: 0, width: "250px", background: "var(--background, white)",
            border: "1px solid var(--border)", borderRadius: "var(--radius)", zIndex: 50,
            boxShadow: "0 4px 6px rgba(0,0,0,0.1)", maxHeight: "300px", overflowY: "auto"
          }}>
            <div style={{ padding: "0.5rem 0.75rem", borderBottom: "1px solid var(--border)", fontWeight: 600, fontSize: "0.875rem" }}>
              Recent Notifications
            </div>
            {newEvents.length === 0 ? (
              <div style={{ padding: "1rem", textAlign: "center", fontSize: "0.875rem", color: "var(--muted)" }}>
                No new notifications
              </div>
            ) : (
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                {newEvents.slice(0, 5).map(event => (
                  <li key={event.eventId} style={{ padding: "0.75rem", borderBottom: "1px solid var(--border)", fontSize: "0.8125rem" }}>
